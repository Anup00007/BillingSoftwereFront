...
itemId:itemId
    ...
    return(
       <div div className='p-3 bg-dark rounded-shadow-sm h-100 d-flex align-items-center item-card'>
<div style={{position:'relative',marginRight:'15px',background:"white"}}>
...
align-items-center justify-content-center ms-3 "style={{height:"100%"}}>
